    ...
    return (
        <div className={"flex justify-between min-w-[500px] not-last:mb-3"}>
            ...
            <div className={"flex flex-col"}>
                <span className={"font-primary text-xs mb-0.5"}>
                    Skills:
                </span>
                {
                    skills.map((skill, i) =>
            ...
            <div className={"grid grid-cols-[auto_auto] gap-x-2"}>
                ...
                <span className={"font-primary text-xs text-end"}>
                    {sold}
                </span>

                <span className={"font-primary text-xs mt-1.5"}>
                    Total:
                </span>
                <span className={"font-primary font-bold text-xs text-green text-end mt-1.5"}>
            ...
            <div className={"flex flex-col items-center gap-2"}>
                ...
                <OverlayButton
                    openOverlayButton={
                        <button className={"stroke-button text-xs px-3.5 py-1.5 rounded-xl"}>
                            Delete
                        </button>
                    }
                    overlayContent={
